...
# Case study: TCGA-KIRC {#case}
In this section, we use the whole datasets of TCGA-KIRC project as an example to illustrate how `GDCRNATools` works in detail.
...
##Rodar a função gdcRNAMerge2 (TA NA PASTA) antes

rnaCounts <- gdcRNAMerge2(metadata  = metaMatrix.RNA, 
